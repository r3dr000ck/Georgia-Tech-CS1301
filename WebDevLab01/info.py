...
experience_data = {
    "Cook at Krusty Krab": (["- Worked on designing the Krabby Patty Recipe","- Increased Company Revenue by 200 dollars", "- Made Mr. Krabs Proud"],"Images/cook.jpg"),
    "Cleaner at Krusty Krab":(["- Made the floor almost reflective","- Increased customer visits by three folds by making restaurant clean"],"Images/cleaner.jpg"),
